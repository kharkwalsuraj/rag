...
# Assuming Chunk, settings, etc., are imported elsewhere

class LLM:
    def __init__(self):
        self.model_id = "gemini-3.6-flash"
        # Securely initialized using the new SDK client syntax
        self.client = genai.Client(api_key=settings.google_api)
    ...
    def generate_answer(self, query: str, chunks: list[Chunk]) -> str:
        ...
        # Cleaner multi-line formatting matching the contents parameter structure
        contents = f"Context:\n{context}\n\nUser Question:\n{query}"
